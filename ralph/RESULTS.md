...
| 4 | 2026-08-27 | Gate B tofu factorial (diagnostics, sigma6000) | 6 (+2 it8, +2 clips) | 6 valid-at-it4 | all drop; effort maintains force but no lift; lock Fn-collapse INVALID; it8 blowup (H5) | gateB.json, gateB-it8.json, gateB_*_run.mp4 | contact stack functional; empty band = material shear/extrusion, not contact bug |

...
| 5 | 2026-08-27 | Gate B2 (viscosity) + Gate C (convergence + yield bracket), diagnostics | 2 + 9 | stable cells consistent | B2 eta2e5 blowup (H2 inconclusive); C converged in stable regime, refinement blows up (H5); yield-shape not gating | gateB2.json, gateC.json, validity_gate_synthesis.md | empty band = material ductile necking (scoped); H2 + convergence open | 
